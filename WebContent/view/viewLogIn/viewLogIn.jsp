	...
	<table class="mainFrame">
		...
		<tr class="mainRow5"><td>
			...
			<form action="viewLogIn_check.do" method="post" name="form_logIn" onsubmit="return viewLogIn_check();">
				...
				<div id="customer_id">	<input name="customer_id" type="text" maxlength="20" placeholder="&nbsp;아이디" autofocus>					</div>
				<div id="customer_pw">	<input name="customer_pw" type="password" maxlength="12" placeholder="&nbsp비밀번호">							</div>
